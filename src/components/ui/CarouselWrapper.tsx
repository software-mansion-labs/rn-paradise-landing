...
function ImageItem({ image, index }: { image: string; index: number }) {
  return (
    <CarouselItem className="basis-auto">
      <div className="group relative aspect-square w-full overflow-hidden transition-[clip-path] duration-500 ease-in-out md:aspect-[4/5] md:[clip-path:inset(20%_0%_0%_0%)] md:hover:[clip-path:inset(0%_0%_0%_0%)]">
        <img
          src={image}
          alt={`Image ${index + 1}`}
